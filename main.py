...
API_TOKEN = '8718835672:AAFukM9HygVOX7TGrsOEO-8LGmcZTP0op3g'
...
def welcome(message):
    ...
    welcome_text = (
        ...
        f"⚠️ **IMPORTANT:** You MUST put your Telegram ID `{chat_id}` in the reason field.\n"
